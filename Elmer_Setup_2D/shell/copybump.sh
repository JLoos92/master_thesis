...
find . -type f -name "Mismip3DInflux.sif" | xargs sed -i '' '198s/.*/Variable 2 data file = File ".\/sDEM\/ZB_bump'$a''$x''$y'_'$dl'.xyz"/g' Mismip3DInflux.sif | scp -r Mismip3DInflux.sif Cluster:/beegfs/work/zxmjf89/
