...
%save('BEDbump200_5001000_0.xyz','BED_bump600','-ASCII');
%save('ZBbump200_5001000_0.xyz','ZB_bump600','-ASCII');

TEST = load('Mismip3DSetUpSteadyState_UniformMesh/TEST.xyz')
TEST_1 = load('Mismip3DSetUpSteadyState_UniformMesh/ZB.xyz') 
TEST_2 = load('Mismip3DSetUpSteadyState_UniformMesh/ZS.xyz')
