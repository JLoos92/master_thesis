...
#            peak_3 = local_minimum_1d(width_2,t)
            ...
            channel_abuts_1.append(hd_regular[8])
            channel_abuts_2.append(hd_extended[8])
            channel_abuts_3.append(hd_extended_wide[8])
            
            print(channel_abuts_1)
            time.append(i*5)
...
#        # Plt properties for ax2 (bridging)  
        ax2 = ax1.twinx()
#        
        ax2.plot(time, channel_abuts_1, 'b-')
        ax2.plot(time, channel_abuts_2, 'b--')
        ax2.plot(time, channel_abuts_3, 'b:')
        ax2.set_ylabel('Dev. of channel abutsments [$MPa$]',labelpad = 15, color = 'b')
...
#        
        ...
        path = str('plots/')
        fname_eps = str('maxpeak_dev_2d__all' + str(original_width(width_2)) + '_' + str(t*5) + 'a' + '.eps')
